-- Workforce Record Ownership Refactor — Sprint 2
-- Switch roster reconciliation commit to company-owned personal and license facts.
...
comment on function core.import_company_roster_rows(text, jsonb) is
  'Commits approved roster reconciliation decisions into company-authoritative workforce warehouses without requiring or creating a profile.';
