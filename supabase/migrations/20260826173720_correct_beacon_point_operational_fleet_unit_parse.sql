...
-- Correct the whitespace parser used by the initial Beacon-only backfill.
-- DSW vehicle_text stores the route/work-area and physical carrier unit as
-- whitespace-separated values (for example: "426    253605").
with observed as (
  select
    batch.company_id,
    batch.service_date,
