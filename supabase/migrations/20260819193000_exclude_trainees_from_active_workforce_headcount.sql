-- Keep the P&D Last Mile workforce analytics definition aligned with the
-- roster lifecycle: Trainee is a development status, not active workforce.
    ...
    'monthly', (
      ...
      select coalesce(jsonb_agg(jsonb_build_object(
        ...
        'known_headcount', (
          ...
          from core.company_roster r
          where r.company_id = v_company_id
            and r.employment_status not in ('Candidate', 'Trainee')
