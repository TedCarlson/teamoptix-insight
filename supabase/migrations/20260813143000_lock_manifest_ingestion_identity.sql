  ...
  loop
    ...
    perform public.register_operations_manifest_artifact(
      ...
      jsonb_build_object(
        ...
        'company_slug', v_artifact.company_slug,
        'transport_filename',
          v_artifact.runner_artifact_json ->> 'transport_filename',
        'source_download_filename',
          v_artifact.runner_artifact_json ->> 'source_download_filename',
        'declared_artifact_key',
          v_artifact.runner_artifact_json ->> 'artifact_key',
        'source_lane', v_artifact.runner_artifact_json ->> 'source_lane',
