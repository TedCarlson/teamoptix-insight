...
export default async function ScannersPage({
  ...
  return (
    <CompanyAssetsPageShell
      title="Scanners"
      description="Scanner inventory, assignment, custody, repair, and replacement tracking."
    >
      <CompanyAssetsTable
        eyebrow="Scanner assets"
        title="Scanner Inventory"
        emptyLabel="No scanner assets have been seeded yet."
