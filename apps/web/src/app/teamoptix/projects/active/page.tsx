      ...
      <main className="workspace-shell">
        <section className="workspace-main">
          <section className="app-card" style={{ padding: 18 }}>
            <p className="value-card__eyebrow">TeamOptix · Projects</p>
            <h1 className="workspace-title">Active Initiatives</h1>
            <p className="workspace-subtitle">Manage current work that deserves attention now.</p>
          </section>
