export default function FleetStatusScan({ status }: { status: Record<string, unknown> | null }) {
  const metrics = [
    ...
    ["Verified GVWR","verified_gvwr"],["Pending verification","pending_gvwr"],["Missing GVWR","missing_gvwr"],
    ["Disputed","disputed_gvwr"],["Small vehicle","small_vehicle_count"],["Over 10K","over_10k_count"],
  ];
