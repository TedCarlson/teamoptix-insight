...
const TARGETS: Record<string, Record<string, unknown>> = {
  DSW: { key: "DSW_DAILY_SERVICE", label: "DSW · Daily Service Worksheet", artifact_key: "DSW", report_family_key: "DSW", runner_section: "DAILY_SERVICE", expected_filename_match: ["daily service worksheet"] },
  FCC: { key: "FCC_SERVICE_AREA", label: "FCC · Service Area Summary", artifact_key: "FCC", report_family_key: "FCC", runner_section: "SERVICE_AREA", expected_filename_match: ["service area summary"] },
  DELIVERY_MANIFEST: { key: "P_AND_D_DELIVERY_MANIFEST", label: "P&D · Delivery Manifest", artifact_key: "DELIVERY_MANIFEST", report_family_key: "FCC", runner_section: "P_AND_D", expected_filename_match: ["DeliveryManifest"] },
  PICKUP_MANIFEST: { key: "P_AND_D_PICKUP_MANIFEST", label: "P&D · Pickup Manifest", artifact_key: "PICKUP_MANIFEST", report_family_key: "FCC", runner_section: "P_AND_D", expected_filename_match: ["PickupManifest", "PM"] },
};
